...
const subCategoryModule = require('../../Models/subCategory.module');
...
exports.createProductValidator = [
  check('title')
   .notEmpty()
    ...
    .custom((val, { req }) => {
      req.body.slug =val.replace(/\s+/g, "-").toLowerCase();
      return true;
    }),
  check('description')
    .notEmpty()
  ...
  check('subCategory')
    ...
    .custom((subcategoriesIds) =>
     ...
     .custom((val, { req }) =>
      subCategoryModule.find({ category: req.body.category }).then(
        (subcategories) => {
